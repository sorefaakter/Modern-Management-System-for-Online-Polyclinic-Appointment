...
<?php include('header.php'); ?>
	...
	<div class="search form-group"  style="background-color: #7faf81;">
		<h3 class="text-center" style="background-color:#BA4A00;color: #fff;padding: 5px;">Search result</h3>
...
<!-- result -->
					...
					if($count>=1){
						...
						?>
							<td><a href="delete_appontment.php?id=<?php echo $row['id'] ?>">Delete</a></td>;
						<?php 		
	...
	<a href="viewAppointment.php">Search Again</a></button>
