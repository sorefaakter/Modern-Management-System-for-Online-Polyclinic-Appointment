...
<!-- result -->
					...
					$sql = " SELECT * FROM feedbacks WHERE id = '" . $_POST["id"]."'";
					...
					if($count>=1){
						...
						?>
							<td><a href="delete_dr_comments.php?id=<?php echo $row['id'] ?>">Delete</a></td>;
						<?php 		
	...
	<a href="viewdoctors_txt.php">Search Again</a></button>
