...
<!-- <?php include('function.php'); ?> -->
	...
	<div class="search" style="background-color:#EAF2F8;">
		<h3 class="text-center" style="background-color:#1F618D;color: #fff;padding: 5px;">Search here for Delete</h3>
		 ...
		 <div class="formstyle" style="padding:70px;border: 1px solid lightgrey;margin-right: 293px;margin-bottom: 30px;background-color:#EAFAF1;color:#141313;width: 530px;margin-left: 400px;">
					<form action="search_dr_result.php" method="post" class="form-group">
		
					<label>
						Doctor ID: <input type="number" name="doc_id" value="<?php echo $id; ?>" placeholder="id" required>
					</label><br>
