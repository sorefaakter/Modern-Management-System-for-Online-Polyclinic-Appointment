...
<?php include('header.php'); ?>
	...
	<div class="dashboard" style="background-color:#fff;">
		<h3 class="text-center" style="background-color:#515A5A;color: #fff;padding: 5px;">All registered Doctor List</h3>
			...
			<div class="all_user" style="margin-top:0px; margin-left: 40px;">
				<?php 
					...
					$sql = " SELECT * FROM doctor WHERE doc_id = '" . $_POST["doc_id"]."'";
					...
					if($count>=1){
						...
						while($row=mysqli_fetch_array($result)){
							...
							<td><a href="delete_doctor.php?id=<?php echo $row['doc_id'] ?>">Delete</a></td>; 
						<?php 
								echo "</tr>";
						}
						echo "</table>";
