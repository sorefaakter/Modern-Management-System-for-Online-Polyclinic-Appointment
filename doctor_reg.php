...
<?php include('header.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Doctor Registration Form</h3>

		<div class="formstyle" style="float: right;padding:25px;border: 1px solid lightgrey;margin-right:320px; margin-bottom:30px;background-color: #EBF5FB;color:#d4530d;;">
		<form enctype="multipart/form-data" method="post" class="text-center" style="margin-left: 110px">
			 <div class="col-md-12">
					...
					<label>
						 Expertise: <select name="expertise" >
					...
					<label>
					     Userid: <input type="text" name="userid" value="" placeholder="userid" >
					</label><br><br>
					<label>
					...
					<label>
					Image: <input type="file" name="pic" value="" id="pic" required>
					</label><br><br>
					
					<button name="submit" type="submit" style="margin-left:148px;margin-top: 4px;width:95px;border-radius: 3px;height: 30px">Submit</button> <br>
							...
							if(move_uploaded_file($_FILES["pic"]["tmp_name"], $target_file)) {
									...
									$sql = "INSERT INTO doctor (name,address,contact,email,expertise,userid,fee,password,pic)
										...
										if ($conn->query($sql) === TRUE) {
										    echo "<script>alert('New Doctor Has been Registration Successfully!');</script>";
										} else {
