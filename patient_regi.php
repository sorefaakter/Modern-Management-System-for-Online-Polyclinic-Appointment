<?php include('header.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		<h3 class="text-center" style="background-color:#2874A6;color: #fff;">Patient Registration</h3>

		<div class="formstyle" style="float: right;padding:25px;border: 1px solid lightgrey;margin-right:415px; margin-bottom:30px;background-color:#85C1E9;color:#17202A ;">
		<form enctype="multipart/form-data" method="post" class="text-center">
			 <div class="col-md-15">
					...
					<label>
						Password: <input type="password" name="password" minlength="4" maxlength="10" size="10" value="" placeholder="Min 4 & Max 10 char" required>
					</label><br><br>
